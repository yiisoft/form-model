...
[interface method implementation](https://github.com/yiisoft/validator/blob/1.x/docs/guide/en/using-validator.md#using-interface-method-implementation):
...
or via 
[PHP attributes](https://github.com/yiisoft/validator/blob/1.x/docs/guide/en/configuring-rules-via-php-attributes.md).
